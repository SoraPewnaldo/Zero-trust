      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/verify" element={<ProtectedRoute requireVerification={false}>
                <EmployeeVerify />
              </ProtectedRoute>} />
            ...
            {/* Resource Dashboards */}
            <Route path="/resource/internal-dashboard" element={<ProtectedRoute>
                <InternalDashboard />
              </ProtectedRoute>} />
            <Route path="/resource/git-repository" element={<ProtectedRoute>
                <GitRepository />
              </ProtectedRoute>} />
            <Route path="/resource/prod-console" element={<ProtectedRoute requiredRole="admin">
                <ProductionConsole />
              </ProtectedRoute>} />
            <Route path="/resource/hr-portal" element={<ProtectedRoute requiredRole="admin">
                <HrPortal />
              </ProtectedRoute>} />
