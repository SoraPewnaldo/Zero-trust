        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              ...
              <button onClick={() => navigate('/login')} className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200" style={{ borderWidth: '1px' }}>
                SECURE LOGIN
              </button>
            </div>
